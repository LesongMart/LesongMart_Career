    ...
    <div class="pb-20">
      ...
      <div class="row pb-10">
        ...
        <div style="margin-left: 3px; margin-right: 3px;" class="pd-20 card-box mb-30">
          <div class="clearfix">
            <div class="pull-left" style="background-color: #d8d8d8; border-color: black; border-style: solid; border-right-style: hidden; border-bottom-style: hidden; padding-left: 10px; padding-right: 10px;">
            ...
            <div class="pull-left" style="border-color: black; border-style: solid; border-bottom-style: hidden; padding-left: 10px; padding-right: 10px;">
      ...
      <?php if($total_records > 0){
        ...
        <td>
          ...
          <button data-href="application_details.php?pid=<?php echo $readrow['id']; ?>" class="btn btn-warning btn-xs" role="button">Details</button>
           ...
           <a href="homepage.php?edit=<?php echo $readrow['id']; ?>" onclick="return confirm('You are sure to accept this application?');" class="btn btn-success btn-xs" role="button">Accept</a>

          <a href="homepage.php?delete=<?php echo $readrow['id']; ?>" onclick="return confirm('You are sure to reject this application?') ; " class="btn btn-danger btn-xs" role="button">Reject</a>
  ...
  <div style="margin-left: 40%;">
      <nav>
        ...
        ?>
          ...
          <?php } else { ?>
            <li><a href="homepage.php?page=<?php echo $page-1 ?>" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
          <?php
          }
          for ($i=1; $i<=$total_pages; $i++)
            if ($i == $page)
              echo "<li class=\"active\"><a href=\"homepage.php?page=$i\">$i</a></li>";
            else
